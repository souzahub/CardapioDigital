...
begin
  ...
  dmDados.QueryLogSys.SQL.Clear;
  dmDados.QueryLogSys.SQL.Add('select * from LOGSYS where');
  dmDados.QueryLogSys.SQL.Add('(LOGIN LIKE  ' +QuotedStr('%' + EdPesquisar.Text + '%'));
  dmDados.QueryLogSys.SQL.Add('or OPERACAO LIKE  ' +QuotedStr('%' + EdPesquisar.Text + '%'));
  dmDados.QueryLogSys.SQL.Add('or DIA LIKE  ' +QuotedStr('%' + EdPesquisar.Text + '%'));
  dmDados.QueryLogSys.SQL.Add(')order by ID desc');
